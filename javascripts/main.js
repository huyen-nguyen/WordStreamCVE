let minWidth = screen.width, height = 900;
...
function loadData(){
    ...
    categories = ["CRITICAL", "HIGH", "LOW","MEDIUM"];
    loadCVE(draw, 25);
}
...
//     let dataWidth = data.length*100;
    ...
    function color(n) {
        var colores = ["#ff0000", "#FF8A07", "#22ab31", "#00e600", "#c7c700", "#8D6BB8", "#85584E" , "#8d6bb8", "#316395", "#994499", "#22aa99", "#aaaa11", "#6633cc", "#e67300", "#8b0707", "#651067", "#329262", "#5574a6", "#3b3eae"];
    ...
    mainGroup.selectAll('g').data(allWords).enter().append('g')
        ...
        .attr({
            ...
            //     if ((d.text === "CWE-119") || (d.text ==="CWE-89") || (d.text ==="CWE-20") || (d.text === "CWE-79")){
            //         return "bold"
            //     }
            //     else {return "normal"}
            // },
             //'fill-opacity': function(d){return 0},
